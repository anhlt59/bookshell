...
def query_logs(query: str, log_groups: List[str], start_time: int, end_time: int):
    def _get_query_results(query_id: str, timeout=15, delay=1):
    ...
    return _get_query_results(query_id)
